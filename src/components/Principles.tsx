...
export const Principles: React.FC = () => {
  return (
    <section className="w-full">
      ...
      <div className="self-center w-full max-w-[1372px] mt-[57px] px-4 max-md:max-w-full max-md:mt-10">
        <div className="gap-5 flex max-md:flex-col max-md:items-stretch">
          <div className="w-[61%] max-md:w-full">
            ...
            />
            <div className="gap-5 flex mt-[17px] max-md:flex-col max-md:items-stretch max-md:max-w-full">
              <article className="w-[30%] max-md:w-full max-md:ml-0">
                <div className="shadow-[0_6px_18px_0_rgba(0,0,0,0.25)] flex flex-col overflow-hidden items-stretch justify-center bg-[#E9F1E1] px-[17px] py-[21px] rounded-[10px] max-md:mt-[13px]">
