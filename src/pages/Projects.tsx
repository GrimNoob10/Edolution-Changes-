          ...
          <div className="box-border flex items-center justify-center gap-5 mb-20 m-0 p-0">
            ...
            <div
              dangerouslySetInnerHTML={{
                __html:
                  "<svg width=\"43\" height=\"30\" viewBox=\"0 0 43 30\" fill=\"none\" xmlns=\"http://www.w3.org/2000/svg\" class=\"section-icon\" style=\"margin: 0; padding: 0; box-sizing: border-box; width: 39px; height: 20px\"> <path d=\"M39.1289 17.6466L29.0715 25.1546L26.0559 12.0816L15.3022 20.1119L12.2866 7.03326L1.67326 15.1196\" stroke=\"#19223F\" stroke-width=\"5.52222\" stroke-miterlimit=\"10\"></path> <path d=\"M40.6738 15.3948L30.6164 22.9028L27.6009 9.82981L16.8471 17.86L13.8315 4.78705L3.21818 12.8678\" stroke=\"#698E45\" stroke-width=\"5.52222\" stroke-miterlimit=\"10\"></path> </svg>",
              }}
            />
          </div>
        ...
        <section id="approach" className="box-border relative m-0 px-0 py-[100px] max-sm:px-0 max-sm:py-[60px]">
          <div className="box-border flex items-center justify-center gap-5 mb-20 m-0 p-0">
            ...
            <div
              dangerouslySetInnerHTML={{
                __html:
                  "<svg width=\"43\" height=\"30\" viewBox=\"0 0 43 30\" fill=\"none\" xmlns=\"http://www.w3.org/2000/svg\" class=\"section-icon\" style=\"margin: 0; padding: 0; box-sizing: border-box; width: 39px; height: 20px\"> <path d=\"M39.1289 17.6464L29.0715 25.1544L26.0559 12.0815L15.3022 20.1117L12.2866 7.03308L1.67326 15.1195\" stroke=\"#19223F\" stroke-width=\"5.52222\" stroke-miterlimit=\"10\"></path> <path d=\"M40.6738 15.3947L30.6164 22.9027L27.6009 9.82974L16.8471 17.86L13.8315 4.78699L3.21818 12.8677\" stroke=\"#698E45\" stroke-width=\"5.52222\" stroke-miterlimit=\"10\"></path> </svg>",
              }}
            />
          </div>
          ...
          <div className="box-border flex gap-10 justify-center m-0 px-[180px] py-0 max-md:flex-col max-md:gap-[30px] max-md:items-center max-md:px-5 max-md:py-0">
            <ApproachCard
              ...
              iconSvg={"<svg width=\"38\" height=\"38\" viewBox=\"0 0 38 38\" fill=\"none\" xmlns=\"http://www.w3.org/2000/svg\" class=\"approach-icon-content\" style=\"margin: 0; padding: 0; box-sizing: border-box; width: 38px; height: 38px\"> <path d=\"M37.6738 25.4416L34.0734 21.8408L26.6251 29.2891C25.2955 30.6186 23.6268 31.4855 21.8142 31.8099L26.5598 36.5555C26.9945 36.9905 27.6996 36.9905 28.1341 36.5555L37.6738 27.0161C38.1087 26.5812 38.1087 25.8761 37.6738 25.4416ZM32.6067 20.1587C33.8617 18.904 33.862 16.862 32.6084 15.6064L32.6041 15.6021C32.2995 15.2968 31.9365 15.0558 31.5369 14.8935C31.879 14.0282 31.9512 12.5646 30.8179 11.4311C30.815 11.4281 30.8121 11.4249 30.8089 11.422C30.5055 11.1198 30.1449 10.8811 29.7481 10.7199C30.0902 9.85506 30.1626 8.39124 29.03 7
" fill=\"none\" xmlns=\"http://www.w3.org/2000/svg\" class=\"approach-bg-pattern\" style=\"margin: 0; padding: 0; box-sizing: border-box; width: 74px; height: 74px\"> <g clip-path=\"url(#clip0_111104_1247)\"> <path d=\"M74 12.3333C74 19.1448 68.4782 24.6667 61.6667 24.6667C54.8552 24.6667 49.3333 19.1448 49.3333 12.3333C49.3333 5.52182 54.8552 0 61.6667 0C68.4782 0 74 5.52182 74 12.3333Z\" fill=\"#698E45\"></path> <path d=\"M74 37C74 43.8115 68.4782 49.3333 61.6667 49.3333C54.8552 49.3333 49.3333 43.8115 49.3333 37C49.3333 30.1885 54.8552 24.6667 61.6667 24.6667C68.4782 24.6667 74 30.1885 74 37Z\" fill=\"#698E45\"></path> <path d=\"M74 61.6667C74 68.4782 68.4782 74 61.6667 74C54.8552 74 49.3333 68.4782 49.3333 61.6667C49.3333 54.8552 54.8552 49.3333 61.6667 49.3333C68.4782 49.3333 74 54.8552 74 61.6667Z\" fill=\"#698E45\"></path> <path d=\"M49.3333 12.3333C49.3333 19.1448 43.8115 24.6667 37 24.6667C30.1885 24.6667 24.6667 19.1448 24.6667 12.3333C24.6667 5.52182 30.1885 0 37 0C43.8115 0 49.3333 5.52182 49.3333 12.3333Z\" fill=\"#698E45\"></path> <path d=\"M49.3333 37C49.3333 43.8115 43.8115 49.3333 37 49.3333C30.1885 49.3333 24.6667 43.8115 24.6667 37C24.6667 30.1885 30.1885 24.6667 37 24.6667C43.8115 24.6667 49.3333 30.1885 49.3333 37Z\" fill=\"#698E45\"></path> <path d=\"M49.3333 61.6667C49.3333 68.4782 43.8115 74 37 74C30.1885 74 24.6667 68.4782 24.6667 61.6667C24.6667 54.8552 30.1885 49.3333 37 49.3333C43.8115 49.3333 49.3333 54.8552 49.3333 61.6667Z\" fill=\"#698E45\"></path> <path d=\"M24.6667 12.3333C24.6667 19.1448 19.1448 24.6667 12.3333 24.6667C5.52182 24.6667 0 19.1448 0 12.3333C0 5.52182 5.52182 0 12.3333 0C19.1448 0 24.6667 5.52182 24.6667 12.3333Z\" fill=\"#698E45\"></path> <path d=\"M24.6667 37C24.6667 43.8115 19.1448 49.3333 12.3333 49.3333C5.52182 49.3333 0 43.8115 0 37C0 30.1885 5.52182 24.6667 12.3333 24.6667C19.1448 24.6667 24.6667 30.1885 24.6667 37Z\" fill=\"#698E45\"></path> <path d=\"M24.6667 61.6667C24.6667 68.4782 19.1448 74 12.3333 74C5.52182 74 0 68.4782 0 61.6667C0 54.8552 5.52182 49.3333 12.3333 49.3333C19.1448 49.3333 24.6667 54.8552 24.6667 61.6667Z\" fill=\"#698E45\"></path> </g> <defs> <clipPath id=\"clip0_111104_1247\"> <rect width=\"74\" height=\"74\" fill=\"white\"></rect> </clipPath> </defs> </svg>"}
            />
